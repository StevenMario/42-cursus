...
/*   Updated: 2024/07/10 21:37:57 by mariosteven      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_wall_image(t_data *game)
{
	...
	game->wall[1] = mlx_xpm_file_to_image(game->mlx_ptr, "img_xpm/mur/wall.xpm", 
	&game->img_height, &game->img_width);
	game->wall[2] = mlx_xpm_file_to_image(game->mlx_ptr, "img_xpm/mur/wall_right.xpm", 
	&game->img_height, &game->img_width);
	game->wall[3] = mlx_xpm_file_to_image(game->mlx_ptr, "img_xpm/mur/wall _left.xpm", 
	&game->img_height, &game->img_width);
	game->wall[4] = mlx_xpm_file_to_image(game->mlx_ptr, "img_xpm/mur/wall_top.xpm", 
	&game->img_height, &game->img_width);
}
